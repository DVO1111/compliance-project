                    ...
                    <div className="bg-[var(--color-surface)] rounded-2xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="p-5 space-y-4">
                            ...
                            {selected.control_code && (
                                <div className="flex items-center gap-2 p-3 rounded-xl bg-[var(--color-purple)]/8 border border-[var(--color-purple)]/20">
                                    <Link2 className="w-4 h-4 text-[var(--color-purple)] shrink-0" />
                                    <p className="text-xs text-[var(--color-purple)]">Auto-generated from control failure: <span className="font-semibold">{selected.control_code}</span></p>
                                </div>
                            )}
