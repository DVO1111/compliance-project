        ...
        <div className="border-t border-[var(--color-border,#e5e7eb)] p-4 space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${isActive ? 'bg-[var(--color-accent)]' : 'bg-gray-300'}`}
            >
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          { label: 'Active rules', value: loading ? '—' : activeRules, icon: <Bell className="w-5 h-5 text-[var(--color-accent)]" />, color: 'text-[var(--color-accent)]' },
      ...
      <div className="flex gap-1 bg-gray-100 dark:bg-gray-800 p-1 rounded-xl w-fit">
        {([
          ...
          <button
            ...
            onClick={() => setTab(id)}
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
              tab === id ? 'bg-white shadow text-[var(--color-accent)] dark:bg-gray-700' : 'text-gray-500 hover:text-gray-800'
            }`}
          >
            {icon}
            {label}
      ...
      {tab === 'history' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button onClick={load} className="text-xs text-[var(--color-accent)] hover:underline flex items-center gap-1">
