  ...
  export function AuthProvider({ children }: { children: ReactNode }) {
    ...
    const reauthenticate = async (password: string): Promise<{ success: boolean; error: Error | null }> => {
    if (!user?.email) {
    ...
    return (
      <AuthContext.Provider
        value={{ user, profile, session, loading, activeBrandId, signUp, verifySignupCode, resendSignupCode, signIn, signOut, refreshProfile, switchBrand, reauthenticate }}
      >
        {children}
      </AuthContext.Provider>
    );
